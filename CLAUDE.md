...
- When a user provides check figures for weekly meeting sales, treat them as validation targets, not as replacement instructions. Recompute from the source workbooks and state the exact basis before changing the HTML. For 2026-08-17 to 2026-08-23, the season mix should be validated against ★와키윌리_26FW 주간 판매리뷰_8월3주차_NEW.xlsx > #주간판매 > current-year 실판매금액: 26FW 93,228,095원, 26SS 567,890,666원, 25FW 111,153,392원, 25SS 135,620,160원, 24FW 이전 합산 41,640,032원, total 949,532,345원. Raw 판매집계현황 prefix sums can differ by season while still matching the same total.
- For APP review sections and APP 주간 BEST 10, exclude ACC/SHOES and ACC-like items. Filter out product codes/categories such as BG, BP, CA, CB, SE, EC and product names containing 양말, 삭스, 백팩, 가방, 볼캡, 캡, or 슬라이드 unless the user explicitly asks for an all-category review.
