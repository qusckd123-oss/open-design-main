...
- Use `workspace/memory/current-teams-update-summary-2026-08-04.md` as the latest Teams update source for decided items, unresolved items, and next actions from Teams chat/channel backup files available on 2026-08-04. The newest local source files are clipped as 2026-08-03 and were written locally on 2026-08-04 morning.
- 2026-08-04 결정된 것: 26FW 추가 SPOT 해외 발주는 `Wacky Willy_26FW LINE SHEET 260413.xlsx`의 `SPOT` 시트에서 `W`, `O` 건을 기준으로 취합한다. QR 채널 파일 권한은 왕지영 대리에게 추가되었고, 해외 발주는 2026-08-06 15:00까지 취합 후 기획이 수량을 대조해 오더 불가 건만 별도 피드백하는 흐름으로 정리되었다. WA2603CRT1, WA2603STT1, WA2603STT2 글로벌 수량은 2026-08-04 국내 입고 예정이며 국내 물량이 없어 글로벌에서 진행한다. WA2603CRT1 대만 PO/글로벌 PO EX-FACTORY는 2026-07-31 기준이고, 글로벌 물량은 국내택으로 교체되어 국내 입고되는 건으로 확인되어 택갈이는 진행하지 않는다. 유니 26FW 뉴베이직 최종 조정 납기 파일이 공유되었고 WA2603PT03/WA2603CR03 솔리드 컬러만 2026-09-18 입고로 조정 요청되었다. 2601 기본 스웻은 재고가 많아 FW 뉴베이직 입고 전까지 RT 시기를 조율한다. 2026-08-04 14:00 사업부 회의는 27SS 품평 때문에 진행하지 않을 가능성이 높고 재일정은 별도 공유한다. 리센느 원이 하트 포즈 등신대 착장은 WA2603CD63 가디건 방향으로 기획 의견을 모은다. 2026년 홀리데이 기획상품은 예정되어 있으며 발주금액은 이번 주 확정 예정이다. SDPK 원가와 KT503 제외 샘플 진행 건은 업데이트되었다. Art Grocery 팝업 인플루언서 촬영 사진은 온라인 썸네일/상세페이지 등 2차 활용이 불가능하다.
- 2026-08-04 안 정해진 것: 26FW 추가 SPOT 해외 발주의 최종 수량, 국가/거래처별 오더 가능 여부, 오더 불가 스타일은 취합 전이라 확정되지 않았다. WA2603CRT1/STT1/STT2의 2026-08-04 실제 입고 완료 여부, 국내택 부착 상태 최종 검수, 2026-08-06 퀵 출고 필요 여부는 후속 확인이 필요하다. WA2603PT03/WA2603CR03 솔리드 컬러의 2026-09-18 입고 가능 수량과 최종 납기, IMC 발매 스타일의 위클리 납기 지연 원인과 납기 단축 가능성, 2601 기본 스웻 RT 실제 전환 시점, 27SS 품평 이후 사업부 회의 재일정, WA2603CD63 등신대 착장 팀장 최종 확인, 홀리데이 기획상품 발주금액/구성/운영 일정은 미확정이다.
- 2026-08-04 다음 할 일: 글로벌팀은 26FW 추가 SPOT 해외 발주를 2026-08-06 15:00까지 `SPOT` 시트의 `W`, `O` 건 기준으로 취합한다. 기획은 취합본 수량을 대조해 오더 불가 건을 피드백한다. WA2603CRT1/STT1/STT2는 2026-08-04 실제 입고 여부, 국내택 부착 상태, 출고 필요 일정을 확인한다. 소싱은 WA2603PT03/WA2603CR03 솔리드 컬러의 2026-09-18 입고 가능 수량을 회신하고 IMC 발매 스타일 납기 지연 원인을 확인한다. 영업/기획은 2601 기본 스웻 재고와 FW 뉴베이직 입고 전환 시점을 같이 보고 RT 일정을 재조정한다. 27SS 품평 이후 사업부 회의 재일정을 공유하고, 리센느 등신대 WA2603CD63 착장과 홀리데이 기획상품 발주금액을 확정한다. Art Grocery 인플루언서 사진 2차 활용 불가 기준을 온라인 운영안에 반영하고 대체 이미지 소스를 검토한다.
