...
- Use `workspace/memory/current-teams-update-summary-2026-08-03.md` as the latest Teams update source for decided items, unresolved items, and next actions from Teams chat/channel backup files available on 2026-08-03. No local Teams backup clipped as 2026-08-03 was found; the newest local source files are clipped as 2026-08-02 and mostly contain messages through 2026-07-31.
- 2026-08-03 결정된 것: 26FW QR/SPOT/REORDER 운영 기준 파일은 계속 `26FW 와키윌리 QR구성(SPOT,Reorder).xlsx`로 유지한다. 26FW 추가 SPOT 진행 건은 QR 채널에도 공유되었고, 해외 오더 여부 확인은 `Wacky Willy_26FW LINE SHEET 260413.xlsx`의 `SPOT` 시트에서 `W`, `O` 건을 필터링해 확인하는 방식으로 안내되었다. 26FW 추가 SPOT 예정 물량은 기존 캐리오버 4건, 인터만 후드집업 1건, 신규 SPOT 3건 기준이며 기본 로고물 방향으로 진행한다. 26FW 입고 지연 예상 스타일은 WA2603CR64, WA2603HZ11, WA2603LT63, WA2603LT64로 공유되었고, WA2603CR64/WA2603HZ11은 2026-09-04, WA2603LT63/LT64는 2026-09-03으로 지연 예상된다. 26FW 채널별/판매별 전략 및 온오프 운영계획 파일은 영업기획에서 작성 중이며, 출고 차수는 기획 출고 기준으로 구성하고 입고 변경 또는 물류 CAPA 이슈 때만 조정한다. 27SS LINE SHEET EX-F 일자는 공장 출고일 기준으로 잡는 방향으로 논의되었고, 리드타임은 미얀마 -10일, 베트남 -5일, 중국은 국내와 동일 수준으로 보는 가이드가 공유되었다. Art Grocery 온라인 전용 상품 가격은 FSS 운영 할인과 동일하게 전 상품 50%로 변경한다.
- 2026-08-03 안 정해진 것: 2026-08-03 당일 Teams 백업은 로컬에서 확인되지 않았다. 26FW 추가 SPOT 해외 오더 수요와 최종 해외 수량, 최종 수량/CAD/작업지시일/발주일/입고 가능일은 텍스트 백업만으로 확정되지 않았다. WA2603CR64, WA2603HZ11, WA2603LT63, WA2603LT64의 실제 최종 합기 확정 여부와 WA2603HZ11 8월 IMC 기준 기존 합기 대응 가능 여부는 미확정이다. 26FW 채널별 판매전략 및 온오프 운영계획 최종본, 27SS LINE SHEET EX-F 국가별 최종 적용값, Art Grocery 등판 그래픽 썸네일 노출 방식, 2026-08-03 Art Grocery SNS 업로드 완료 여부, 2026-08-04 27SS 샘플 품평 준비 상태는 추가 확인이 필요하다.
- 2026-08-03 다음 할 일: 26FW 추가 SPOT은 `SPOT` 시트의 `W`, `O` 건을 필터링해 해외 오더 여부와 필요 수량을 확정하고 발주 리스트/QR 운영 파일에 동기화한다. WA2603CR64, WA2603HZ11, WA2603LT63, WA2603LT64의 최종 합기와 추가 지연 가능성을 소싱과 재확인하고 WA2603HZ11은 8월 IMC 기준 기존 합기 대응 가능성을 별도 확인한다. 26FW 채널별 판매전략 및 온오프 운영계획 최종본을 차주 미팅에서 회수해 매장 CAPA와 SKU 과다 이슈를 반영한 출고 차수 플랜을 확정한다. 27SS LINE SHEET EX-F 기준을 국가별 리드타임으로 정리해 글로벌 캠페인 라인 시트에 반영한다. 캔슬/비축 원단 리스트, 대만 실납 합기(AD열), 업체 실납 합기(AE열), 아이즈아이들 확인 스타일, WA2603CR16 글로벌 PO 3건, WA2603PT56 대만 판매가, WA2603CRT1/STT1/STT2 EX-FAC 진행 상태를 추적한다. Art Grocery 온라인 전용 상품 50% 가격 반영, 무신사/29CM/자사몰 업로드 상태, 등판 그래픽 썸네일 노출 방식, SNS 업로드 완료 여부를 확인한다.
