...
- Default section 5 to `검토 필요 사항`. Use `주간회의 논의 사항` only when the user provides actual meeting notes, agenda text, or explicitly asks to include discussion items; otherwise do not write inferred items as if they were real meeting discussion.
- When a user provides check figures for weekly meeting sales, treat them as validation targets, not as values to force into the report. Recompute from the source workbooks, identify the matching sheet/columns, and only then update the HTML. For 2026-08-17 to 2026-08-23, the user's season mix was verified against `★와키윌리_26FW 주간 판매리뷰_8월3주차_NEW.xlsx` > `#주간판매` > 금년 side `실판매금액`: 26FW 93,228,095원, 26SS 567,890,666원, 25FW 111,153,392원, 25SS 135,620,160원, 다년차 41,640,032원, 합계 949,532,345원.
- For APP review sections and `APP 주간 BEST 10`, exclude ACC/SHOES and ACC-like items even when they share season prefixes: bags/backpacks (`BG`, `BP`), hats/caps (`CA`, `CB`), shoes (`SE`), event/freebie codes (`EC`), and product names containing `양말`, `삭스`, `백팩`, `가방`, `볼캡`, `캡`, or `슬라이드`. Keep these only as reference KPI/context.
...
## Current Teams Summary - 2026-08-27

- Use `workspace/memory/current-teams-update-summary-2026-08-27.md` as the latest Teams update source for decided items, unresolved items, and next actions from local Teams chat/channel backup files written on 2026-08-27 morning and clipped as 2026-08-26. No live Teams connector was available in this Codex session, so this source is limited to the local backup files. The newest substantive local Teams messages found are dated 2026-08-26.
- 2026-08-27 결정된 것: 27SS 대물량 스타일은 원가율을 낮추기 위해 작업지시서와 B/T를 빠르게 선진행한다. 27SS 발주서 생산국(CO)은 협력사/수량 변동으로 별도 정리 데이터가 없어 우선 공란으로 넘기고 소싱 담당자가 수기 입력한다. 2PACK 신규 패키지는 기존 패키지와 달리 행잉 가능한 구조가 아닌 형태로 개발된 점을 운영/진열 검토에 반영한다. 유니 신규 2PACK 패키지 문구는 C100이 아니라 C/P 쿨코튼 기준이므로 기존 쿨코튼 2PACK 문구와 동일하게 수정한다. 2PACK 신규 패키지 문구와 도안은 2026-08-27 목요일까지 정리해 업체에 전달하고, 패키지 업체 샘플 원단은 금요일 준비 및 샘플 투입 예정이다. 2PACK 신규 샘플은 빨라야 2026-09-01 가능하고 폴리백 생산만 3주가 걸리며 중국 연휴가 겹치면 제품 납기 10월 말도 어려울 수 있다. 피그먼트 다잉 관련 `리커버릭` 업체의 소재 퀄리티와 단가를 확인 요청했다. 지산 거래 종결로 30수 싱글 스판 원단은 HNC에 개발 요청한다. 글로벌 오더를 받은 뒤 유니/우먼 변경사항을 전체 정리해 공유한다. WA2603HZ55는 최종 PO SHEET 기준으로 대만 지사와 확인해 O.C 리스트를 수정하고 메일 회신한다. WA2604DP11 대만 판매가는 5,490으로 기입 완료됐다. 원이 프리오더 기획전 페이지는 착장컷, 컬러별 제품컷, 간단한 셀링포인트, 할인율 강조가 필요하며, 큰 구조 변경 대신 현재 이미지에 상품 누끼컷을 추가해 보강한다. 상품 누끼컷은 2026-08-28 수급 예정이므로 소속사에는 현재 이미지를 먼저 컨펌 받고 하단 누끼컷은 추가되는 전제로 진행한다. 누끼컷 추가는 별도 컨펌 없이 진행 가능하다는 사업부 의견이 공유됐다. 26FW QR 채널의 최신 2026-08-26 백업에는 신규 2026-08-26 메시지 본문이 없었고 기존 SPOT/QR 운영 원칙을 유지한다.
- 2026-08-27 안 정해진 것: 27SS 대물량 스타일의 실제 작지 전달 가능일, B/T 선진행 완료일, 원가율 개선 효과, 발주서 생산국(CO) 최종 입력 완료 여부는 확정되지 않았다. 2PACK 신규 패키지의 최종 문구, 뒷면 도안, 품질보증서 대표번호 변경 여부, 2026-09-01 샘플 가능 여부, 10월 말 납기 가능 여부, 행잉 구조가 아닌 패키지의 FSS/면세 진열 보완 방식은 미정이다. 피그먼트 다잉 소재의 리커버릭 단가/퀄리티, SDPK 및 타 협력사 비딩 결과, 69,000원 판매가 기준 25% 원가율 달성 가능 여부도 미정이다. WA2603HZ55의 대만 O.C 리스트 수정 완료와 부킹 지연 해소 여부, 원이 프리오더 기획전 최종 시안/누끼컷 반영/소속사 컨펌 결과/할인율 강조 방식은 후속 확인이 필요하다. 2026-08-27 당일 실제 Teams 대화는 로컬 백업에 아직 포함되어 있지 않아 확인하지 못했다.
- 2026-08-27 다음 할 일: 27SS 대물량 스타일별 작지 전달 가능일을 회신받고 B/T 선진행 대상과 우선순위를 확정한다. 27SS 발주서 생산국 칸은 공란 기준으로 소싱에 넘긴 뒤 수기 입력 완료 후 품번별 CO를 재검수한다. 2PACK 신규 패키지 문구는 C/P 쿨코튼 기준으로 수정하고 뒷면 문구 및 품질보증서 대표번호 변경 여부를 2026-08-27까지 확인해 업체에 전달한다. 패키지 샘플 원단 준비, 금요일 샘플 투입, 2026-09-01 샘플 가능 여부, 10월 말 납기 리스크를 일정표에 반영한다. 행잉 구조가 아닌 신규 2PACK 패키지의 FSS/면세 진열 방식을 VM/영업 쪽과 확인한다. 리커버릭 피그먼트 다잉 소재 퀄리티와 단가를 확인하고 SDPK 및 타 협력사 비딩과 비교해 `WA2700STE6` 원가율 가능성을 판단한다. HNC 30수 싱글 스판 개발 요청 상태를 추적한다. 글로벌 오더 수취 후 유니/우먼 변경사항을 정리해 공유한다. WA2603HZ55는 대만 지사 확인, O.C 리스트 수정, 메일 회신, 부킹 진행 상태를 추적한다. 원이 프리오더 기획전은 현재 이미지로 소속사 1차 컨펌을 받고 2026-08-28 누끼컷 수급 후 페이지를 보강한다.

## Current Teams Summary - 2026-08-26

- Use `workspace/memory/current-teams-update-summary-2026-08-26.md` as the latest Teams update source for decided items, unresolved items, and next actions from local Teams chat/channel backup files written on 2026-08-26 morning and clipped as 2026-08-25. No actual 2026-08-26 message body was found in the local backup set.
- 2026-08-26 결정된 것: 27SS 상품 MAP은 2026-08-25 업데이트 완료 후 공유됐고 지급/우선 투입 대상은 MAP 표시 기준으로 진행한다. 27SS 시즌부터 소싱팀 R&R이 변경됐으며 최종 협력사 배분 시트에 소싱 담당자도 함께 기재해 작업지시서 작성 시 참고한다. 27SS 확정 소재 관리는 기존 파일에 `확정 소재처`와 `확정소재` 열을 추가해 업데이트하고, B/T 불출일자, 혼용률, 원단가 열도 추가됐다. 27SS 최종 협력사 미정 건은 2026-08-26 중 업데이트 예정이며, 최종 확정 원단과 현재 배정 협력사가 다르면 각 소싱 담당자에게 인폼한다. 27SS 발주/작지 진행은 우선 국내 수량 기준 내부 결재를 먼저 돌리고 글로벌 수량은 월말 회신 후 최종 결재 시 추가 반영한다. 27SS 재고 소진 계획에는 `SO01`, `SO02` 스타일이 추가됐고 재고 소진 원단 스와치는 HNC/부림 등 협력사에 요청 후 수취 즉시 공유한다. 면세/FSS 전용 2PACK 폴리백은 리드타임 때문에 선발주를 진행하며 유니 `WA2603STE4` 월드 진행 2,500장분, 우먼 `WA2603STE5` 2,500장분 발주를 요청했다. 폴리백 리드타임은 PO 후 약 30~35일이며 10월 하순 입고를 위해 이번 건은 추가 샘플링 없이 진행하는 방향이다. 폴리백 예상 사입가는 유니 14,500원(V-), 우먼 12,500원(V-)로 1차 공유됐고, 컬러 샘플링 1회 추가와 200원 추가를 감안해 남성 14,000원(V-), 여성 12,700원(V-) 수준으로 인지하기로 했다. 유니 2PACK 패키지는 사양 변동 없이 S/O 컬러만 조정하고 메인 발주 후 SO 점검 단계에서 수정한다. `WA2700STE6` 피그먼트 다잉 2PACK은 69,000원 판매가, 25% 원가율 타겟 기준으로 SDPK 외 타 협력사까지 비딩 검토한다. 더현대 팝업 리스트는 프리오더존 삭제에 따라 경량아우터/플리스 아이템을 원이 착장컷 스타일 제외하고 제외, 유니 중 우먼스향 스타일과 우먼 ST/LT 스타일 추가, 더현대 익스클루시브 스타일 표기 기준으로 정리됐고 파자마 2SKU도 추가 대상이다. 더현대 팝업 리스트는 약 100~102 SKU 기준이며 파자마 2SKU 현재 납기는 2026-10-20이다. 2026-08-26 용품 1차 미팅은 오전으로 당겨졌고 27SS 유니 ACC 및 우먼 ACC 시장조사는 2026-08-25 퇴근 전 제출 대상으로 공유됐다. 26FW 유니 뉴베이직 추석 전 입고 예정 SKU/수량은 `유니 26FW 뉴베이직 조정 납기 - 최종 0806.xlsx` 기준으로 공유됐다. 27SS 영업기획 피드백은 변경 가능한 부분만 우선순위를 두고 검토하고, 수정이 어려운 부분은 사유를 별도 정리해 공유한다. 자사몰 오픈은 세일즈포스 불안정 이슈로 매주 화요일 오전 11시 고정 오픈, 오전 10시 선오픈/사전 점검으로 운영한다. 원이 에디토리얼/기획전은 2026-08-25 11시 오픈 기준으로 진행됐고 비회원 구매 테스트는 문제없는 것으로 확인됐다. 세일즈포스 이미지 CDN 캐시 문제로 WA2603 신상 14스타일 색상별 28개 상품에서 로고 이미지 노출 이슈가 있었으나 캐시 강제 초기화 후 정상 노출 확인됐다. 세일즈포스 수정 송신 시 기존 데이터 삭제 문제는 개발자에게 전달됐고 2026년 8월 말까지 해결 예정이다. 원이 이미지 성명권은 공개일 기준 6개월, 2027-02-25까지 사용 가능하며 이미지 교체기간 1개월이 포함된다. 일본 택 입고 품목은 세원 ERP `입고 현황`의 발주번호상 `일본` 또는 `수주-일본` 표기와 카톤 `JP` 스티커로 확인한다.
- 2026-08-26 안 정해진 것: 27SS 최종 협력사 미정 건의 실제 업데이트 완료 여부와 최종 배정 결과, 확정 소재 리스트의 최종 원단/확정 소재처/혼용률/원단가 입력 완료 여부, 협력사 배정 변경 여부는 확인이 필요하다. 27SS 영업기획 수량 피드백 중 어떤 스타일이 확정이고 어떤 스타일에 룸이 남아 있는지, 전달 파일 기준 최종 적용 수량이 발주리스트에 모두 반영됐는지는 미정이다. 면세/FSS 전용 2PACK 폴리백의 최종 컬러 샘플 승인, 최종 사입가, 실제 PO 발행 여부, 10월 하순 입고 가능 여부는 확정 전이다. 우먼 `WA2603STE5` 제품 아트워크 도안 변경 여부와 변경 도안 확정 여부는 디자이너 핸들링 중이다. `WA2700STE6` 피그먼트 다잉 2PACK의 최종 협력사, SDPK 외 비딩 결과, 69,000원 판매가 기준 25% 원가율 달성 가능 여부는 미정이다. 더현대 팝업 100~102 SKU 리스트에서 우먼스 FW 반팔/롱슬리브가 실제 행사 시점 재고 부족 없이 투입 가능한지, 파자마 2SKU를 2026-10-20 납기로도 팝업 운영에 포함할지 최종 판단이 필요하다. 2026-08-26 용품 1차 미팅에서 확정될 품목/방향, 세일즈포스 데이터 삭제 이슈의 실제 개발 완료 여부, 원이 스쿨백 품절 해제와 채널별 재고 반영 안정화, 무신사 차주 빅배너 비딩 결과와 원이 착장컷/성명권 적용 범위는 확정 전이다.
- 2026-08-26 다음 할 일: 27SS 상품 MAP과 발주리스트 기준으로 우선 투입/지급 표시 품목을 확인하고 최종 협력사·소싱 담당자·확정 소재처·확정소재·B/T 불출일자·혼용률·원단가 입력을 마감한다. 협력사 배정과 최종 원단 협력사가 다른 스타일은 각 소싱 담당자에게 즉시 인폼하고 배정표를 수정한다. 영업기획팀은 27SS 수량 피드백에서 확정 스타일과 추가 조정 가능 스타일을 구분해 회신하고 기획팀은 반영 가능/불가 사유를 정리해 공유한다. 면세/FSS 전용 2PACK 폴리백은 유니 2,500장, 우먼 2,500장 선발주 PO 발행 상태를 확인하고 컬러 샘플/아트워크 변경/최종 사입가/10월 하순 입고 가능성을 확정한다. `WA2700STE6` 피그먼트 다잉 2PACK은 SDPK와 타 협력사 비딩을 받아 69,000원 판매가 기준 25% 원가율 가능 여부를 판단한다. 더현대 팝업 리스트는 프리오더존 삭제 기준, 원이 착장컷 예외, 유니 우먼스향 스타일, 우먼 ST/LT, 더현대 익스클루시브, 파자마 2SKU를 반영한 100~102 SKU 후보를 최종 재고 기준으로 검수한다. 자사몰은 화요일 10시 선오픈/11시 정상 오픈 프로세스를 표준 운영하고 세일즈포스 데이터 삭제 이슈가 발견되면 즉시 공유한다. 일본 택 물량 출고 요청 시 세원 ERP 입고 현황에서 품번별 `일본`/`수주-일본` 표기와 카톤 `JP` 스티커를 재확인한다.

## Current Teams Summary - 2026-08-25

- Use `workspace/memory/current-teams-update-summary-2026-08-25.md` as the latest Teams update source for decided items, unresolved items, and next actions from local Teams chat/channel backup files updated on 2026-08-25 morning and clipped as 2026-08-24. This supersedes the 2026-08-24 memory because the new backup contains actual 2026-08-24 messages.
- 2026-08-25 결정된 것: 27SS 추가 스타일 중 샘플 미진행 건은 견적 산출용 작업지시서가 필요하며 봄 품번과 10,000PCS 이상 대물량 스타일을 우선 챙긴다. 작지 수취 후 견적 산출에는 최소 2~3일이 필요하다. 27SS 추가 스타일은 2026-08-24 당일 다시 정리해 디자인실에 전달하고 봄 아이템 작지 불출은 금주까지 완료하는 방향이다. 26FW/27SS 1차 원가 수정안은 소싱팀장이 2026-08-28 금요일 전까지 전달한다. 27SS 생산계획은 금주 재수립 후 공유하고 영업기획팀 27SS 수량 피드백은 2026-08-27 목요일까지 받는다. 저가형 기획 플리스는 목표 택가 59,000~69,000원 대응이 어려워 진행하지 않는 것으로 정리됐다. 26FW 신상은 직영/백화점 우선, 아울렛 후출고 기준으로 유통별 배분 점검을 계속 진행한다. 2026-08-24 기준 8월 4주차 등록 상황은 계획 대비 -14%, 전년 대비 -6%, 26FW 초도 입고율 약 38%, 출고율 약 37%이며 9월 1주차 출고 가능 SKU는 전년 85SKU 대비 금년 52SKU로 공유됐다. 시즌별 주간 실판매금액은 26FW 9,323만원, 26SS 5억 6,789만원, 25FW 1억 1,115만원, 25SS 1억 3,562만원, 다년차 4,164만원, 합계 9억 4,953만원이다. 26SS APP 8월 3주 매출은 4.85억, 전년비 -0.7%, 전주대비 -2.4%이며 26FW APP은 7,321만원, 전년비 -65.5%, 전주대비 +91.9%다. 먼작귀 콜라보 7개 품번은 4,997만원/737pcs, WoW +49.5%로 확대 국면이다. 26FW 우먼 CD는 2,015만원/201pcs, WoW +107.8%, 전년비 +31.1%로 우먼 26FW 내 유일한 전년 대비 플러스 카테고리다. MDP 수정 기준은 뉴스타일/추가 필요 스타일 레퍼런스 사진, MD 데이터 기반 필요 컬러, 캐리오버 품번+사진, 설명/컬러/그림 중심 정리로 확정됐다. `WA2603CD53`와 `WA2603KT62`는 PO SHEET 수량 기준으로 출고하고 O.C 파일은 그 기준에 맞춰 반영한다. `WA2603CRW1`과 `WA2603CR52`는 EX-FAC 일정을 O.C 파일에 업데이트했고 선적서류는 2026-08-25 중 공유 예정이다. 26SS/FW 판매추이, 주간 RAW 데이터, 매장형태별 판매 대시보드는 2026-08-24 업데이트 및 공유가 완료됐다.
- 2026-08-25 안 정해진 것: 1차 원가 수정안의 실제 내용, 최종 원가율, 대물량 스타일별 원가 임팩트는 2026-08-28 전 회신 전까지 미정이다. 27SS 추가 스타일 중 견적용 작지 대상 최종 리스트, 디자인실 전달 후 실제 작지 불출 일정, 작지 수취 후 협력사 견적 완료일은 확정 전이다. 27SS 최종 생산계획, 품목별 STY/SKU, 수량, TAG 피드백 반영안은 영업기획팀 2026-08-27 회신 후 재정리해야 한다. 26FW 입고 지연이 9월 말 정상화될 때까지 추석 전 필요 스타일을 얼마나 당길 수 있는지, 신상 제품 유통별 출고 배분이 충분한지는 2026-08-25 회의 확인이 필요하다. MDP 수정본 완료 및 디자인실 전달/이해 여부, `WA2603CRW1`/`WA2603CR52` 선적서류 실제 공유 여부, 현대 중동점 가이드 작업의 최종 적용 리스트는 확인되지 않았다.
- 2026-08-25 다음 할 일: 27SS 추가 스타일은 봄 품번과 10,000PCS 이상 대물량 스타일부터 작업지시서 필요 대상을 소팅하고 디자인실 전달본과 작지 불출 일정표를 맞춘다. 소싱팀은 2026-08-28 전 1차 원가 수정안을 전달하고 기획팀은 대물량 스타일 원가 임팩트와 생산계획 반영 여부를 점검한다. 영업기획팀은 2026-08-27까지 27SS 수량 피드백을 전달하고 기획팀은 금주 재수립한 27SS 생산계획과 함께 공유한다. 26FW 신상은 입고 즉시 직영/백화점 우선 출고, 아울렛 후출고 기준으로 배분을 점검하고 2026-08-25 회의에서 입고율/출고율/출고 가능 SKU 부족 이슈를 소싱팀과 확인한다. MDP 수정본은 레퍼런스 사진, 필요 컬러, 캐리오버 품번/사진, 설명/컬러/그림 정리 기준을 반영했는지 확인 후 디자인실에 재전달한다. `WA2603CD53`/`WA2603KT62`는 PO SHEET 수량 기준 출고와 O.C 파일 수정 반영 여부를 확인하고, `WA2603CRW1`/`WA2603CR52`는 2026-08-25 선적서류 공유 여부와 O.C EX-FAC 업데이트 상태를 확인한다.

## Current Teams Summary - 2026-08-24

- Use `workspace/memory/current-teams-update-summary-2026-08-24.md` as the latest Teams update source for decided items, unresolved items, and next actions from local Teams chat/channel backup files updated through 2026-08-24 morning. The newest backup snapshots are clipped as 2026-08-23, and no actual message body dated 2026-08-22, 2026-08-23, or 2026-08-24 was found; the newest substantive Teams messages are dated 2026-08-21.
- 2026-08-24 결정된 것: 더현대 원이 팝업은 점포 사정으로 프리오더와 프리오더용 샘플 제작을 진행하지 않는다. 팝업 상품 구성은 원이 착장 중심 우먼스 라인과 일부 여성향 유니섹스 제품, VM 기준 DP capa 200 SKU와 실제 90~100 SKU 내외, 전품목 20% 할인, 원이 싸인 볼캡 GWP와 스쿨백 리오더를 기준으로 한다. 27SS 면세/FSS 전용 2PACK은 26FW 품번 `WA2603STE4`(유니)와 `WA2603STE5`(우먼)로 먼저 진행한다. 27SS 3PACK은 우선 FSS/면세 중심으로 운영하고 판매 부진 시 아울렛 확대 방향이다. 27SS 추가 진행 스타일은 발주리스트 `스팟`과 상품 MAP `품번 파란색 음영`으로 구분한다. 26FW 상품설명서 추가 업데이트는 `26FW 의류` 시트에 진행한다. 광복 FSS는 그래픽 티셔츠 4 SKU를 우선 진행하며 2026-09-17 입고 완료를 최우선 타겟으로 하고, 그래픽 2개는 각각 100개씩 2026-09-18 입고로 진행한다. 광복 FSS 전용 모자는 2 ST, 각 1 SKU로 샘플 진행 후 기본 볼캡/딥커버핏 중 최종 쉐입을 고른다. 광복점은 싱글헹잉 중심으로 다양한 상품을 노출한다. `WA2501EC01`은 사은품 전환 진행으로 확인됐다. `WA2603HZ51`/`WA2603PT51` LG/LP 컬러는 입고 완료, NA 컬러는 부자재 이슈로 2026-09-11 입고 예정이다.
- 2026-08-24 안 정해진 것: FSS/면세 전용 2PACK 신규 패키지 사양 FIX 여부, 실제 납기, 신규 패키지 3주 리드타임 반영 가능 여부, 중국 휴무 영향은 미확정이다. `WA2603STE4`/`WA2603STE5` 원가는 예상치만 공유됐고 최종 확정 전이다. 27SS 품목별 최종 STY/SKU 계획, S1/S2 계획, TAG/수량 피드백 회신 기한과 27SS 협력사 최종 배정은 미정이다. 우먼스 스커트 사이즈 이슈는 추가 발주와 보완 방식 확정이 필요하다. 광복 FSS 단독상품 품번, 익스클루시브 사용 수량, 인증샷 프로모션 추가 할인율 방식은 미정이다. `WA2603CD53`, `WA2603KT62`는 PO SHEET와 O.C 수량/컬러 차이 확인이 필요하고, `WA2603LT17` 납기 2026-08-24 vs 2026-08-31도 확인해야 한다.
- 2026-08-24 다음 할 일: 더현대 원이 팝업은 프리오더 제외 기준으로 성현진 팀장이 최종 리스트를 공유하고 MDP 수정 건을 2026-08-24 월요일 아침 미팅에서 논의한다. FSS/면세 전용 2PACK은 디자인팀 패키지 FIX, 소싱 납기, 원가를 확정한다. 27SS 협력사 배정과 영업기획 A~C 등급/스타일별 의견을 반영하고, 영업기획팀에 최종 STY/SKU 계획과 피드백 기한을 회신한다. 26FW 주요상품은 추석 전 입고 필요 스타일 중심으로 소싱팀과 재협의한다. 광복 FSS 그래픽 티셔츠, 모자 CAD/품번, 싱글헹잉 SKU 구성, 대만/일본 직송 O.C/PO 차이 해소를 계속 추적한다.
...
- 2026-08-20 결정된 것: 27SS 2PACK/3PACK 원단은 원사 발주를 먼저 진행했다. 기존 기준은 2PACK 20,000SET, 3PACK 10,000SET이며 2PACK에는 WH 컬러 추가분이 포함된다. 27SS 3PACK은 10,000SET 우선 진행 후 판매 흐름에 따라 추가 판단하는 방향을 유지한다. JL 폴리백은 20,000SET가 미니멈이며 5,000SET 진행 시 약 1,715원, 10,000SET 이상이면 금액이 상쇄되는 구조로 공유됐다. 3PACK/패키지 관련 3개 스타일은 스픽에 작업지시서가 먼저 전달됐다. 광복점 EXCLUSIVE는 총 4STYLE/4SKU, 스타일당 1SKU씩 예상 200장 기준으로 진행 예정이며 9/18 IN DC는 당일 작업지시서 발행 기준이다. 소재/BT 방향은 오픈에이 진행, 오픈에이 BT 불출, 20수 싱글 기준이다. WA2601LT15는 전전주 대비 3PCS에서 66PCS로 상승했고, 금일 점심 전 PO 불출 기준 700~1,000PCS 진행 시 원가율 23.8%, 10/1~10/2 납기 예상으로 공유됐다. 27SS 유니 재고 원단 소진 계획 스타일이 잡혔고 `27SS 재고 원단 소진 계획.xlsx`로 공유됐다. 26FW SPOT 해외 오더 1,885PCS는 PO 분리 없이 국내 입고 후 글로벌팀 이관, 별도 택갈이 없이 국내택 부착 상태로 진행한다. 대만 직송 O.C 파일은 복원 후 새 경로로 재업로드됐고, WA2603HD62는 9/8 EX-FAC 예정으로 변경되어 O.C 파일 반영이 완료됐다. WA2603HZ51 NA 컬러는 부자재 이슈로 해당 컬러만 9/8 EX-FAC 가능할 것으로 공유됐다.
- 2026-08-20 안 정해진 것: 2PACK/3PACK 원사 발주는 진행됐지만 최종 PO 발행 완료 여부와 발주 파일 반영 완료 여부는 확인이 필요하다. 3PACK 10,000SET의 채널별 배분과 RT 실행 수량은 미정이다. 플래그쉽/면세 전용 2PACK 패키지 아이템은 화이트 컬러 2컬러 각각 2,500장씩, 연간 2PACK 물량 차감 안이 논의됐으나 영업기획과 컬러/수량 협의가 필요하다. WA2601LT15는 리오더 납기와 원가율이 공유됐지만 영업기획 리오더 미진행 의견과 마케팅 직접 활용 리스크가 있어 최종 리오더 여부가 확정되지 않았다. 광복점 EXCLUSIVE 1스타일은 2026-08-19 오전 기준 아트웍이 미확정이다. 27SS 재고 원단 소진 계획의 기존 협력사 이관 가능 여부와 최종 품번, 27SS 상품 MAP 추가 스타일 표기 방식, 26FW 미드레이어 온라인 프리오더 상세페이지/상품사진/마케팅 일정, 대만 직송 WA2603LT15/WA2603HZ62/WA2603PT13/WA2603CR62 및 CR12/HD61의 ETD-ETA/출고 요청 상태, WA2604JK21 판매가 기재 완료 여부는 추가 확인이 필요하다.
- 2026-08-20 다음 할 일: 2PACK/3PACK 원사 발주가 실제 PO와 발주 파일에 반영됐는지 확인한다. 3PACK은 8/20 면세 판매 반영 후 가용 재고를 확인해 단기 리오더와 27SS 10,000SET 선입고 계획을 분리 확정한다. 플래그쉽/면세 전용 2PACK 패키지 아이템의 컬러, 수량, 연간 물량 차감 방식을 영업기획과 확정한다. WA2601LT15는 영업기획 미진행 의견, 700~1,000PCS 진행 시 원가율/납기, 마케팅 리스크를 놓고 최종 리오더 여부를 결정한다. 광복점 EXCLUSIVE는 미확정 아트웍 1스타일을 FIX하고 4STYLE/4SKU 작업지시서, 오픈에이 BT 불출, 9/18 IN DC 가능성을 재확인한다. 27SS 유니 재고 원단 소진 계획은 협력사 이관 가능 여부를 확인하고 `★27SS 아이템별 상품 MAP.xlsx`와 진행 품번을 맞춘다. 26FW 필요 스타일과 미드레이어 온라인 프리오더는 입고/출고 일정, 상세페이지 가능 여부, 상품사진/상세컷 수급, 마케팅 일정 협의를 마무리한다. 대만 직송은 복원된 O.C 파일 기준으로 각 품번의 O.C 반영, 출고 요청, ETD-ETA, 대만지사 소통 상태를 업데이트한다.
...
- 2026-08-20 continuation: expanded the fixed URL app into the originally planned three dashboard views as tabs: `리오더 의사결정`, `주간 상품 성과`, and `신상품 런칭 반응`.
