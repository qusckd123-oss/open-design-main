...
PNG_PATH = OUT_DIR / "26FW_color_trend_clean_visual_board_v2.png"
PDF_PATH = OUT_DIR / "26FW_color_trend_clean_visual_board_v2.pdf"
...
WGSN = [
    ("Transformative Teal", "Coloro 092-37-14", "#315F5D", "Main"),
    ("Wax Paper", "Coloro 035-88-12", "#F0E4B8", "Neutral"),
    ("Fresh Purple", "Coloro 136-32-33", "#6E3BAA", "Accent"),
    ("Cocoa Powder", "Coloro 008-35-06", "#5A3A33", "Brown"),
    ("Green Glow", "Coloro 057-82-32", "#C9D84A", "Highlight"),
]
...
y += 74
d.text((M, y), "Verified sources: WGSN/Coloro official key colors + Pantone NYFW AW26/27 report", font=F["sub"], fill=MUTED)
y += 55
d.rounded_rectangle([M, y, W - M, y + 78], radius=16, fill=PAPER, outline="#E5E0D6")
d.text((M + 24, y + 23), "Direction: warm neutrals, brown and black base with teal, purple, chartreuse and fuchsia accents", font=F["body"], fill=TEXT)
y += 126
...
d.text((M + 24, y + 22), "Reliability Check", font=F["h"], fill=TEXT)
d.text((M + 24, y + 70), "High: color names and codes are confirmed via WGSN/Coloro and Pantone official source pages. Runway and retail reviews are supporting evidence.", font=F["small"], fill=TEXT)

d.text((M, H - 58), "Swatches are approximate for report visualization. Use official Pantone TCX or Coloro physical swatches before production.", font=F["small"], fill=MUTED)
